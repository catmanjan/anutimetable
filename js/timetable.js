...
var recover         = false;
var jsonUpdatedTime = '16th of January, 2019';
var revisionNum     = 134;
...
if (typeof global === 'undefined' || typeof global.it !== 'function') {
    $(function () {
        ...
        $.get('./data/timetable.json?VERSION=' + revisionNum, {}, function (data) {
            ...
            Calendar.updateView();
            Calendar.shiftWeek(-42); // This is a stupid hack to get the correct week to display before the current week gets changed. Please remove this if you find a work around!
